      ...
      <section class="columns">
        <div class="columns__column">
          ...
          <Segment title="Work" icon="briefcase">
            <p>I currently working as senior full-stack developer at <Link href="https://www.ksyos.nl/" target="_blank">Ksyos</Link> based in Amsterdam. We are working with the Node.js, React, Typescript and PostgreSQL techstack.</p>
          </Segment>
